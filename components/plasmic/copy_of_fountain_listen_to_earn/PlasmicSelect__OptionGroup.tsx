...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: HcU0jiGAOqwS5b/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 9Fq70lGFEjIoj/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___1Cvxu)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__tVp4T)}
              />
            </React.Fragment>
          ),
          value: args.children
