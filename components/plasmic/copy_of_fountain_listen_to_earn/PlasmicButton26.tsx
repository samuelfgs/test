...
import sty from "./PlasmicButton26.module.css"; // plasmic-import: HWDGyz8n4e3RQ4/css
...
export type PlasmicButton26__VariantMembers = {
...
export type PlasmicButton26__VariantsArgs = {
...
type VariantPropType = keyof PlasmicButton26__VariantsArgs;
export const PlasmicButton26__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicButton26__ArgsType = {
...
type ArgPropType = keyof PlasmicButton26__ArgsType;
export const PlasmicButton26__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicButton26__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultButton26Props extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
export const defaultButton26__Args: Partial<PlasmicButton26__ArgsType> = {};

function PlasmicButton26__RenderFunc(props: {
  variants: PlasmicButton26__VariantsArgs;
  args: PlasmicButton26__ArgsType;
  overrides: PlasmicButton26__OverridesType;

  forNode?: string;
}) {
  const { variants, overrides, forNode } = props;
  const args = Object.assign({}, defaultButton26__Args, props.args);
  const $props = args;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__y816G)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__yjRyc)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButton26>(
    PlasmicButton26,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicButton26__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButton26__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicButton26__ArgsType, ReservedPropsType> &
