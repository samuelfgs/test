...
import sty from "./PlasmicButton3.module.css"; // plasmic-import: vUBLLTox2S7sxg/css
...
export const defaultButton3__Args: Partial<PlasmicButton3__ArgsType> = {};
...
function PlasmicButton3__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultButton3__Args, props.args);
  const $props = args;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__s3BDg)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__iSc4P)}
                role={"img"}
              />
            ),
