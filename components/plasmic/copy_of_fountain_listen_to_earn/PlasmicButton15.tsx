...
import sty from "./PlasmicButton15.module.css"; // plasmic-import: YfrgJw37980fpD/css
...
export type PlasmicButton15__VariantMembers = {
...
export type PlasmicButton15__VariantsArgs = {
...
type VariantPropType = keyof PlasmicButton15__VariantsArgs;
export const PlasmicButton15__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicButton15__ArgsType = {
...
type ArgPropType = keyof PlasmicButton15__ArgsType;
export const PlasmicButton15__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicButton15__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultButton15Props extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
export const defaultButton15__Args: Partial<PlasmicButton15__ArgsType> = {};

function PlasmicButton15__RenderFunc(props: {
  variants: PlasmicButton15__VariantsArgs;
  args: PlasmicButton15__ArgsType;
  overrides: PlasmicButton15__OverridesType;

  forNode?: string;
}) {
  const { variants, overrides, forNode } = props;
  const args = Object.assign({}, defaultButton15__Args, props.args);
  const $props = args;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__wqyjT)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__fwMfw)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButton15>(
    PlasmicButton15,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicButton15__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButton15__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicButton15__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  const func = function <T extends PropsType>(
    ...
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicButton15__ArgProps,
      internalVariantPropNames: PlasmicButton15__VariantProps
    });

    return PlasmicButton15__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButton15";
  } else {
    func.displayName = `PlasmicButton15.${nodeName}`;
  }
  return func;
}

export const PlasmicButton15 = Object.assign(
  // Top-level PlasmicButton15 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButton15
    internalVariantProps: PlasmicButton15__VariantProps,
    internalArgProps: PlasmicButton15__ArgProps,

    useBehavior
  }
);

export default PlasmicButton15;
/* prettier-ignore-end */
