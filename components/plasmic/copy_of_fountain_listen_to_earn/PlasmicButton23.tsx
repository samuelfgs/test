...
import sty from "./PlasmicButton23.module.css"; // plasmic-import: sfO-FAEcHAa_Q6/css
...
export type PlasmicButton23__VariantMembers = {
...
export type PlasmicButton23__VariantsArgs = {
...
type VariantPropType = keyof PlasmicButton23__VariantsArgs;
export const PlasmicButton23__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicButton23__ArgsType = {
...
type ArgPropType = keyof PlasmicButton23__ArgsType;
export const PlasmicButton23__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicButton23__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultButton23Props extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
export const defaultButton23__Args: Partial<PlasmicButton23__ArgsType> = {};

function PlasmicButton23__RenderFunc(props: {
  variants: PlasmicButton23__VariantsArgs;
  args: PlasmicButton23__ArgsType;
  overrides: PlasmicButton23__OverridesType;

  forNode?: string;
}) {
  const { variants, overrides, forNode } = props;
  const args = Object.assign({}, defaultButton23__Args, props.args);
  const $props = args;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___8PhPk)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__kcefi)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButton23>(
    PlasmicButton23,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicButton23__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButton23__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicButton23__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  const func = function <T extends PropsType>(
    ...
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicButton23__ArgProps,
      internalVariantPropNames: PlasmicButton23__VariantProps
    });

    return PlasmicButton23__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButton23";
  } else {
    func.displayName = `PlasmicButton23.${nodeName}`;
  }
  return func;
}

export const PlasmicButton23 = Object.assign(
  // Top-level PlasmicButton23 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButton23
    internalVariantProps: PlasmicButton23__VariantProps,
    internalArgProps: PlasmicButton23__ArgProps,

    useBehavior
  }
);

export default PlasmicButton23;
/* prettier-ignore-end */
