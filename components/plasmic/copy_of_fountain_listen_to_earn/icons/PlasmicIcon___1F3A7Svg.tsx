...
export type _1F3A7SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function _1F3A7SvgIcon(props: _1F3A7SvgIconProps) {
  ...
  return (
    ...
    >
      ...
      <path
        fill={"#9B9B9A"}
        d={
          "M27.447 62.537l-.402-22.913c-1.72 1.054-6.131 5.563-6.591 11.82-.48 6.516 5.053 10.2 6.993 11.093zM44.716 39.53l-.16 22.912c1.01-.46 2.988-.817 4.603-2.856 1.502-1.895 2.69-5.37 2.496-8.49-.17-2.719-.822-5.428-2.058-7.295-1.596-2.411-3.92-3.662-4.881-4.272z"
        }
      ></path>
      ...
      >
        <path
          d={
            "M31.161 40.634a3.026 3.026 0 011.643 2.688v15.504c0 1.23-.74 2.285-1.8 2.748m-3.462-21.95s-6.354 1.785-7.068 11.489 6.973 11.424 6.973 11.424l.095-22.913zm13.317 1.002a3.022 3.022 0 00-1.446 2.542l-.173 15.504a2.997 2.997 0 001.816 2.788m3.66-21.93s6.334 1.855 6.939 11.566c.605 9.71-7.1 11.346-7.1 11.346l.161-22.913z"
          }
        ></path>

        <path
          d={
            "M58.047 53.808c3.21-5.058 5.09-11.17 5.09-18.189 0-15.759-11.353-28.536-27.106-28.552v0H36v0C20.247 7.083 8.895 19.86 8.895 35.619c0 7.019 1.88 13.13 5.088 18.19"
          }
        ></path>

        <path
          d={
            "M50.214 20.194c-3.133-4.444-8.167-7.312-14.189-7.318v-.001h-.02v0c-5.996.007-11.013 2.85-14.148 7.262"
          }
        ></path>
      </g>
    </svg>
