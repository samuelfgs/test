...
import sty from "./PlasmicButton9.module.css"; // plasmic-import: 6XwhPFUOmymtlX/css
...
export type PlasmicButton9__VariantMembers = {
...
export type PlasmicButton9__VariantsArgs = {
...
type VariantPropType = keyof PlasmicButton9__VariantsArgs;
export const PlasmicButton9__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicButton9__ArgsType = {
...
type ArgPropType = keyof PlasmicButton9__ArgsType;
export const PlasmicButton9__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicButton9__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultButton9Props extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
export const defaultButton9__Args: Partial<PlasmicButton9__ArgsType> = {};

function PlasmicButton9__RenderFunc(props: {
  variants: PlasmicButton9__VariantsArgs;
  args: PlasmicButton9__ArgsType;
  overrides: PlasmicButton9__OverridesType;

  forNode?: string;
}) {
  const { variants, overrides, forNode } = props;
  const args = Object.assign({}, defaultButton9__Args, props.args);
  const $props = args;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__seqBv)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__sw36N)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButton9>(
    PlasmicButton9,
    props,
    {
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButton9__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicButton9__ArgsType, ReservedPropsType> &
