...
import sty from "./PlasmicButton7.module.css"; // plasmic-import: PM9HK5niLWTM13/css
...
export const PlasmicButton7__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export interface DefaultButton7Props extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
export const defaultButton7__Args: Partial<PlasmicButton7__ArgsType> = {};
...
function PlasmicButton7__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultButton7__Args, props.args);
  const $props = args;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ptmJz)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg___6GwN)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButton7>(
    PlasmicButton7,
    props,
    {
