...
import sty from "./PlasmicButton5.module.css"; // plasmic-import: -OAuykX0tb9heR/css
...
export interface DefaultButton5Props extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
export const defaultButton5__Args: Partial<PlasmicButton5__ArgsType> = {};
...
function PlasmicButton5__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultButton5__Args, props.args);
  const $props = args;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__gwfwQ)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__yj25B)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicButton5>(
    PlasmicButton5,
    props,
    {
