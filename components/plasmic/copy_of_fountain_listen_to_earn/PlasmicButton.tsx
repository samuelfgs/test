...
import sty from "./PlasmicButton.module.css"; // plasmic-import: KhbeBVaAisx47/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__srl5A)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "color", "clear") ? true : true) ? (
        <div
