...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 903aArRJQYa/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: jxdAacVy7uB/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: nduVfQmWHO8/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lTbkC)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__n4KZ)}
                role={"img"}
              />
            ),
